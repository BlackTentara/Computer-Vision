...
# For example, we can set a threshold of 128 to split the image into two regions
threshold = 64
...
# Display the Sobel Horizontal (X) edge detection image
ax3.imshow(sobel_image_x, cmap='gray')
ax3.set_title('Sobel Horizontal (X)')

# Display the Sobel Vertical (Y) edge detection image
ax4.imshow(sobel_image_y, cmap='gray')
...
# Display the Sobel magnitude edge detection
ax7.imshow(sobel_image, cmap='gray')
